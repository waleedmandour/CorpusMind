...
class Assistant:
    ...
    SYSTEM_PROMPT = (
        ...
        "### Image-Set / Vision Results (CorpusMind Lens)\n"
        "get_corpus_overview returns BOTH sides of a corpus: text_side "
        "(documents, tokens) and vision_side (image sets, images). "
