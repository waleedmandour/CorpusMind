 ...
 * GET /api/v1/version and returns it as a display string (e.g. "v0.1.11").
 *
...
export function useEngineVersion(): string {
  ...
  // The engine returns { version: "0.1.11", name: "corpusmind-engine" }
  return query.data?.version ?? FALLBACK_VERSION;
}

/** Returns the version with a leading "v" (e.g. "v0.1.11") for display. */
